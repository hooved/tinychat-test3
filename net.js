...
@compute @workgroup_size(256) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  if (((bool(lidx0))!=true)) {
    ...
    const buf_11 = createWeightBuf(device, 513024, getTensorBuffer(safetensor, metadata['tok_embeddings.arange']));
    const buf_12 = createWeightBuf(device, 1050673152, getTensorBuffer(safetensor, metadata['tok_embeddings.weight']));
    ...
    const buf_17 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.0.attention_norm.weight']));
    const buf_18 = createEmptyBuf(device, 2097152);;
    const buf_19 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.0.attention.wv.weight']));
    const buf_20 = createEmptyBuf(device, 8388608);;
    const buf_21 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.0.attention.wq.weight']));
    const buf_22 = createEmptyBuf(device, 2097152);;
    const buf_23 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.0.attention.wk.weight']));
    const buf_24 = createWeightBuf(device, 524288, getTensorBuffer(safetensor, metadata['freqs_cis']));
    ...
    const buf_30 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.0.attention.wo.weight']));
    const buf_31 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.0.ffn_norm.weight']));
    const buf_32 = createEmptyBuf(device, 33554432);;
    const buf_33 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.0.feed_forward.w3.weight']));
    const buf_34 = createEmptyBuf(device, 33554432);;
    const buf_35 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.0.feed_forward.w1.weight']));
    const buf_36 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.0.feed_forward.w2.weight']));
    const buf_37 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.1.attention_norm.weight']));
    const buf_38 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.1.attention.wv.weight']));
    const buf_39 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.1.attention.wq.weight']));
    const buf_40 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.1.attention.wk.weight']));
    const buf_41 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.1.attention.wo.weight']));
    const buf_42 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.1.ffn_norm.weight']));
    const buf_43 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.1.feed_forward.w3.weight']));
    const buf_44 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.1.feed_forward.w1.weight']));
    const buf_45 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.1.feed_forward.w2.weight']));
    const buf_46 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.2.attention_norm.weight']));
    const buf_47 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.2.attention.wv.weight']));
    const buf_48 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.2.attention.wq.weight']));
    const buf_49 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.2.attention.wk.weight']));
    ...
    const buf_54 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.2.feed_forward.w2.weight']));
    const buf_55 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.3.attention_norm.weight']));
    const buf_56 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.3.attention.wv.weight']));
    const buf_57 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.3.attention.wq.weight']));
    const buf_58 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.3.attention.wk.weight']));
    const buf_59 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.3.attention.wo.weight']));
    const buf_60 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.3.ffn_norm.weight']));
    const buf_61 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.3.feed_forward.w3.weight']));
    const buf_62 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.3.feed_forward.w1.weight']));
    const buf_63 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.3.feed_forward.w2.weight']));
    const buf_64 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.4.attention_norm.weight']));
    const buf_65 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.4.attention.wv.weight']));
    const buf_66 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.4.attention.wq.weight']));
    const buf_67 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.4.attention.wk.weight']));
    const buf_68 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.4.attention.wo.weight']));
    const buf_69 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.4.ffn_norm.weight']));
    const buf_70 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.4.feed_forward.w3.weight']));
    const buf_71 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.4.feed_forward.w1.weight']));
    const buf_72 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.4.feed_forward.w2.weight']));
    const buf_73 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.5.attention_norm.weight']));
    const buf_74 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.5.attention.wv.weight']));
    const buf_75 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.5.attention.wq.weight']));
    const buf_76 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.5.attention.wk.weight']));
    const buf_77 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.5.attention.wo.weight']));
    const buf_78 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.5.ffn_norm.weight']));
    const buf_79 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.5.feed_forward.w3.weight']));
    const buf_80 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.5.feed_forward.w1.weight']));
    const buf_81 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.5.feed_forward.w2.weight']));
    const buf_82 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.6.attention_norm.weight']));
    const buf_83 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.6.attention.wv.weight']));
    const buf_84 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.6.attention.wq.weight']));
    const buf_85 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.6.attention.wk.weight']));
    const buf_86 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.6.attention.wo.weight']));
    const buf_87 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.6.ffn_norm.weight']));
    const buf_88 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.6.feed_forward.w3.weight']));
    const buf_89 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.6.feed_forward.w1.weight']));
    const buf_90 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.6.feed_forward.w2.weight']));
    const buf_91 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.7.attention_norm.weight']));
    const buf_92 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.7.attention.wv.weight']));
    const buf_93 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.7.attention.wq.weight']));
    const buf_94 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.7.attention.wk.weight']));
    const buf_95 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.7.attention.wo.weight']));
    const buf_96 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.7.ffn_norm.weight']));
    const buf_97 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.7.feed_forward.w3.weight']));
    const buf_98 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.7.feed_forward.w1.weight']));
    const buf_99 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.7.feed_forward.w2.weight']));
    const buf_100 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.8.attention_norm.weight']));
    const buf_101 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.8.attention.wv.weight']));
    const buf_102 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.8.attention.wq.weight']));
    const buf_103 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.8.attention.wk.weight']));
    const buf_104 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.8.attention.wo.weight']));
    const buf_105 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.8.ffn_norm.weight']));
    const buf_106 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.8.feed_forward.w3.weight']));
    const buf_107 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.8.feed_forward.w1.weight']));
    const buf_108 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.8.feed_forward.w2.weight']));
    const buf_109 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.9.attention_norm.weight']));
    const buf_110 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.9.attention.wv.weight']));
    const buf_111 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.9.attention.wq.weight']));
    const buf_112 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.9.attention.wk.weight']));
    const buf_113 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.9.attention.wo.weight']));
    const buf_114 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.9.ffn_norm.weight']));
    const buf_115 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.9.feed_forward.w3.weight']));
    const buf_116 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.9.feed_forward.w1.weight']));
    const buf_117 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.9.feed_forward.w2.weight']));
    const buf_118 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.10.attention_norm.weight']));
    const buf_119 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.10.attention.wv.weight']));
    const buf_120 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.10.attention.wq.weight']));
    const buf_121 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.10.attention.wk.weight']));
    const buf_122 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.10.attention.wo.weight']));
    const buf_123 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.10.ffn_norm.weight']));
    const buf_124 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.10.feed_forward.w3.weight']));
    const buf_125 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.10.feed_forward.w1.weight']));
    const buf_126 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.10.feed_forward.w2.weight']));
    const buf_127 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.11.attention_norm.weight']));
    const buf_128 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.11.attention.wv.weight']));
    const buf_129 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.11.attention.wq.weight']));
    const buf_130 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.11.attention.wk.weight']));
    const buf_131 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.11.attention.wo.weight']));
    const buf_132 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.11.ffn_norm.weight']));
    const buf_133 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.11.feed_forward.w3.weight']));
    const buf_134 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.11.feed_forward.w1.weight']));
    const buf_135 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.11.feed_forward.w2.weight']));
    const buf_136 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.12.attention_norm.weight']));
    const buf_137 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.12.attention.wv.weight']));
    const buf_138 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.12.attention.wq.weight']));
    const buf_139 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.12.attention.wk.weight']));
    const buf_140 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.12.attention.wo.weight']));
    const buf_141 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.12.ffn_norm.weight']));
    const buf_142 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.12.feed_forward.w3.weight']));
    const buf_143 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.12.feed_forward.w1.weight']));
    const buf_144 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.12.feed_forward.w2.weight']));
    const buf_145 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.13.attention_norm.weight']));
    const buf_146 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.13.attention.wv.weight']));
    const buf_147 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.13.attention.wq.weight']));
    const buf_148 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.13.attention.wk.weight']));
    const buf_149 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.13.attention.wo.weight']));
    const buf_150 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.13.ffn_norm.weight']));
    const buf_151 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.13.feed_forward.w3.weight']));
    const buf_152 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.13.feed_forward.w1.weight']));
    const buf_153 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.13.feed_forward.w2.weight']));
    const buf_154 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.14.attention_norm.weight']));
    const buf_155 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.14.attention.wv.weight']));
    const buf_156 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.14.attention.wq.weight']));
    const buf_157 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.14.attention.wk.weight']));
    const buf_158 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.14.attention.wo.weight']));
    const buf_159 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.14.ffn_norm.weight']));
    const buf_160 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.14.feed_forward.w3.weight']));
    const buf_161 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.14.feed_forward.w1.weight']));
    const buf_162 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.14.feed_forward.w2.weight']));
    const buf_163 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.15.attention_norm.weight']));
    const buf_164 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.15.attention.wv.weight']));
    const buf_165 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.15.attention.wq.weight']));
    const buf_166 = createWeightBuf(device, 4194304, getTensorBuffer(safetensor, metadata['layers.15.attention.wk.weight']));
    const buf_167 = createWeightBuf(device, 16777216, getTensorBuffer(safetensor, metadata['layers.15.attention.wo.weight']));
    const buf_168 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['layers.15.ffn_norm.weight']));
    const buf_169 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.15.feed_forward.w3.weight']));
    const buf_170 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.15.feed_forward.w1.weight']));
    const buf_171 = createEmptyBuf(device, 8388608);;
    const buf_172 = createWeightBuf(device, 67108864, getTensorBuffer(safetensor, metadata['layers.15.feed_forward.w2.weight']));
    const buf_173 = createWeightBuf(device, 8192, getTensorBuffer(safetensor, metadata['norm.weight']));
    const buf_174 = createEmptyBuf(device, 525336576);;
    const buf_175 = createWeightBuf(device, 1050673152, getTensorBuffer(safetensor, metadata['output.weight']));
